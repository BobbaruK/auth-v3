...
export default function Error({
  ...
  return (
    <div className="bg-background @container grid h-dvh w-full place-items-center">
      <div className="text-foreground flex max-w-4xl flex-col items-center justify-center px-5 @4xl:flex-row">
        <div className="flex w-full flex-col gap-4 text-center @4xl:text-start">
          <div>
            <h1 className="font-dark text-5xl font-bold">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <CustomButton
              ...
              linkHref="/"
              className="self-center @4xl:self-start"
            />
          </div>
        </div>

...
const MagicLinkTemplate = ({ email, url }: Props) => {
  return (
    <Html lang="en" dir="ltr">
      <Tailwind>
        ...
        <Preview>Your secure login link is ready</Preview>
        <Body className="my-[10px] bg-gray-100 py-[40px] font-sans">
          <Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[32px]">
            <HeaderEmail
              ...
              description="Click the button below to securely access your account
...
"
            ...
            <Section>
              ...
              <Text className="mb-[24px] text-[16px] leading-[24px] text-gray-700">
                We received a request to sign in to your account associated with{" "}
                <strong>{email}</strong>. Click the secure link below to
                complete your login:
              </Text>
              ...
              <SecurityNotice>
                <Text className="m-0 text-[14px] leading-[20px] text-gray-600">
                  • This link will expire in <strong>5 minutes</strong> for your
                  security
                </Text>
                <Text className="m-0 text-[14px] leading-[20px] text-gray-600">

const MESSAGES_FN = () => {
  return {
    ...
    EMAIL_OLD_NOT_MATCH: "The email provided does not match your current email address.",
    ...
    PASSWORD_NEW: "Your password has been reset. Please log in with your new password.",
    PASSWORD_RESET: "Success! A password reset confirmation email has been sent.",
    PASSWORD_SET: "Your password has been set successfully. You can now log in.",
    ...
    REGISTRATION_SUCCESS: "Registration complete. Please verify your email address.",
    SESSION_EXPIRED: "Your session has expired. Please log in again.",
    SESSION_REVOKED_ALL: "All sessions have been successfully revoked.",
    SESSION_REVOKED_OTHERS: "All other sessions have been successfully revoked.",
    SESSION_REVOKED: "Your session has been revoked.",
    SOMETHING_WRONG: "Something went wrong. Please try again later.",
    TOKEN_INVALID: "The provided token is invalid.",
    TOKEN_MISSING: "No token was provided.",
    TWO_FACTOR_DISABLED: "Two-factor authentication has been successfully disabled.",
    USER_ADMIN_BAN: "You have successfully banned this user:",
    USER_ADMIN_IMPERSONATE: "You have successfully impersonated this user:",
    USER_ADMIN_OWNER: "You cannot ban, delete or impersonate a user with the role of OWNER.",
